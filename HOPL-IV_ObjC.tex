...
\end{longtable}
%%\clearpage
\section{Historical PPI internal documents provided by Steve Naroff, c.1987--1988}
Documents begin on next page
\includepdf[pages=-, pagecommand={\thispagestyle{plain}}]{SnaroffEarlyObjCDesignNotes.pdf}
