...
Blaine Garst remembers protocols being inspired by modules in Modula \citep[22--25, 54]{garst_oral_2016}. Naroff, however, believes that the notion of declaring an abstract interface for others to implement was inspired by C++ ``pure virtual'' functions. Instead of adopting the C++ idiom verbatim, however, the team distinguished concrete types (i.e., classes) from abstract types (i.e., protocols). In turn, protocols in Objective-C inspired interfaces in the Java language, according to James Gosling \citep[13--14]{gosling_oral_2019} and Patrick Naughton \citepNA{patrick_naughton_java_nodate}. Unlike Objective-C, Java interfaces and classes are in the same namespace. Naroff likes Java's simplification for local programming tasks, but doesn't think it fits well with forwarding/proxies. 
...
\end{longtable}
%%\clearpage
%%\section{Historical document: Design Issues for Objective-C DRAFT of July 3, 1987, S. Naroff, A. Watt, PPI}
%%\begin{center}
%%    \includegraphics[width=\linewidth, page=1]{SNaroffAWatt1987ObjCDesignIssues.pdf}
%%\end{center}
\includepdf[pages=1, 
width=\linewidth, 
...
%%\includepdf[pages={2-last}, pagecommand={\thispagestyle{plain}}]{SNaroffAWatt1987ObjCDesignIssues.pdf}
\includepdf[pages={2-}, pagecommand={}, link=true] {SNaroffAWatt1987ObjCDesignIssues.pdf}

%%\section{Historical document: Objective-C v.4.0 charts, Stepstone, 1988}
%%\begin{center}
    %%\includegraphics[width=\linewidth, page=1]{Stepstone1988ObjC4_0Charts.pdf}
%%\end{center}
\includepdf[pages=1, 
...
\includepdf[pages={2-last}, pagecommand={},
link=true]
{Stepstone1988ObjC4_0Charts.pdf}

%%\section{Historical document: Functional Specification: Class Declaration Syntax and Run-Time Selector Mapping in the Objective-C Language (spec.language), S. Naroff, c.1987--1988}
%%\begin{center}
  %%  \includegraphics[width=\linewidth, page=1]{SNaroffSpec_language.pdf}
%%\end{center}
\includepdf[pages=1, 
width=\linewidth, 
pagecommand={\section{Historical document: Functional Specification: Class Declaration Syntax and Run-Time Selector Mapping in the Objective-C Language (spec.language), S. Naroff, c.1987--1988}
\label{appendix_spec.language}}, 
link=true]
{SNaroffSpec_language.pdf}
\includepdf[pages={2-last}, pagecommand={}, link=true]{SNaroffSpec_language.pdf}

%%\section{Historical document: Design Notebook: Selector Mapping in the Objective-C Run-Time Support System (spec.runtime), S. Naroff, c.1987--1988}
%%\begin{center}
  %%  \includegraphics[width=\linewidth, page=1]{SNaroffSpec_runtime.pdf}
%%\end{center}
\includepdf[pages=1, 
width=\linewidth, 
pagecommand={\section{Historical document: Design Notebook: Selector Mapping in the Objective-C Run-Time Support System (spec.runtime), S. Naroff, c.1987--1988}
\label{appendix_spec.runtime}}, 
link=true]
{SNaroffSpec_runtime.pdf}
\includepdf[pages={2-last}, pagecommand={}]{SNaroffSpec_runtime.pdf}
