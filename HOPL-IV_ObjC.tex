...
%% Title information
\title{The Origins of Objective-C at PPI/Stepstone and Its Evolution at NeXT}         %% [Short Title] is optional;
...
width=\linewidth,
link=true,
pagecommand={\section{Historical document: spec.language, S. Naroff, c.1987}
\label{appendix_spec.language}
\tikz \fill[fill=white] (0,0) rectangle (\linewidth, 1in);
},
picturecommand*={}
]
{SNaroffSpec-language.pdf}
\includepdf[pages={2-last}, 
width=\linewidth,
link=true,
pagecommand={}]
...
link=true,
pagecommand={
\section{Historical document: spec.runtime, S. Naroff, c.1987}
